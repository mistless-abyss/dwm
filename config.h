...
static const char *fonts[]          = { "DejaVuSansMNerdFontMono:pixelsize=24" };
static const char dmenufont[]       = "DejaVuSansMNerdFontMono:pixelsize=24";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#e5e9f0", "#3b4252", "#81a1c1" },
	[SchemeSel]  = { "#eceff4", "#81a1c1", "#e5e9f0" },
};
...
static const Rule rules[] = {
	...
	{ "dwmwidgets",NULL,     NULL,           0,         0,          0,           0,        -1 },
